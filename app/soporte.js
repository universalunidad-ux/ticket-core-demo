import{$,$$,toast,esc,debounce}from"./global.js?v=frontend-p0-20260811-01";
import{supabase}from"./supabase.js";
import{poblarSelect,montarBuscadorEquipo}from"./janome/janome_catalogo.js?v=frontend-p0-20260811-01";
...
/* B17C43D: límites diferenciados — 3 imágenes (5MB c/u), 1 video (40MB, 15 s), 1 PDF (5MB), 5 archivos, 60MB total */
const ST={files:[],sending:false,notice:null,faq:null,faqDismissed:new Set()},MAX_FILES=5,MAX_IMG=3,MAX_VID=1,MAX_PDF=1,MAX_VID_SECONDS=15,MAX_MB_IMG=5,MAX_MB_PDF=5,MAX_MB_VID=40,MAX_MB_TOTAL=60,ALLOWED_EXT=["jpg","jpeg","png","webp","heic","heif","mp4","mov","m4v","pdf"],ALLOWED_MIME=["image/jpeg","image/png","image/webp","image/heic","image/heif","video/mp4","video/quicktime","video/x-m4v","application/pdf"];
